...
import { dossiers, statusLabels } from '@/data/mock-data';
import { DossierClient } from '@/types/hunters';
import { motion } from 'framer-motion';

const pipelineStatuses: DossierClient['status'][] = ['nouveau', 'conseil', 'chasse', 'visite', 'offre', 'compromis', 'signe'];
                    ...
                    {statusDossiers.map((d, idx) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <span className="text-xs text-muted-foreground">{d.mandataireName.split(' ')[0]}</span>
                        </div>
                      </motion.div>
                    ))}

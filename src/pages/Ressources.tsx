...
const CAT_META = {
  client: { label: 'Documents clients', icon: FileText, color: 'text-[#004621]', bg: 'bg-[#E8F2EC]', desc: 'Remis et signés avec le client à chaque étape' },
...
const TYPE_COLORS: Record<string, string> = {
  docx: 'bg-[#E8F2EC] text-[#004621] border border-[#004621]/20',
      ...
      <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { label: 'Docs clients', value: counts.client, icon: FileText, color: 'text-[#004621]' },

...
Object.getPrototypeOf((supabase as any).functions).invoke = async (...a: any[]) => { console.log('QA invoke stub called', a[0]); return { data: { ok: true, rapport: FAKE_RAPPORT }, error: null }; };
